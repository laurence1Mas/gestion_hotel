...
const stats = [
  { label: "Réservations Actives", value: "2", icon: CalendarDays, color: "bg-primary/10 text-primary" },
  { label: "Hôtels Visités", value: "5", icon: Hotel, color: "bg-accent/10 text-accent" },
  { label: "Nuits Totales", value: "12", icon: Clock, color: "bg-chart-3/10 text-chart-3" },
]
    ...
    <div className="space-y-6">
            ...
            >
              ...
              <div className="flex-1 space-y-2">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <h4 className="font-semibold text-foreground">{reservation.hotel}</h4>
                ...
                <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                  ...
                  <span className="font-semibold text-foreground">${reservation.price}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="font-serif text-xl font-semibold">Hôtels Recommandés</h3>
          <Button asChild variant="ghost" className="rounded-full text-primary">
            <Link href="/hotels">
              Voir plus
              <ArrowRight className="w-4 h-4 ml-1" />
              ...
              <Card className="rounded-2xl overflow-hidden hover:shadow-lg transition-shadow group">
                ...
                <CardContent className="p-4">
                  ...
                  <p className="mt-2 text-primary font-semibold">
                    ${hotel.price}<span className="text-muted-foreground font-normal text-sm">/nuit</span>
                  </p>
                </CardContent>
              </Card>
            </Link>
